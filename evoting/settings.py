...
SECRET_KEY = 'xsze_%bvqt94q0-9k5!w_6d!qep%9u9)@f9^wli3i6kpufq+bs'
...
WEBSOCKET_PORT = 8888
WEBSOCKET_CERTFILE = os.path.join(BASE_DIR, 'cert/cert.pem')
WEBSOCKET_KEYFILE = os.path.join(BASE_DIR, 'cert/key.key')
